...
export function Ticker() {
  ...
  return (
    <div className="overflow-hidden whitespace-nowrap relative py-[14px]" style={{ background: "var(--ink)" }}>
      ...
      <div className="inline-flex items-center" style={{ animation: "tick 28s linear infinite" }}>
        {items.map((item, i) => (
          <div key={i} className="inline-flex items-center gap-[14px] px-8 text-[12.5px] font-normal tracking-[0.01em]" style={{ color: "rgba(255,255,255,0.45)" }}>
...
export function Logos() {
  return (
    <section className="px-[52px] py-16 max-[1080px]:px-8 max-[1080px]:py-12" style={{ borderBottom: "1px solid var(--border)" }}>
      <div className="max-w-[var(--max)] mx-auto flex items-center gap-16 max-[1080px]:flex-col max-[1080px]:gap-6 max-[1080px]:items-start">
...
export function Problem() {
  return (
    <section className="section-padding py-[120px] max-[1080px]:py-20 grid gap-[100px] max-[1080px]:grid-cols-1 max-[1080px]:gap-14" style={{ gridTemplateColumns: "380px 1fr" }}>
      <ScrollReveal>
        <div className="eyebrow mb-6"><span className="inline-block w-6 h-px" style={{ background: "var(--ink4)" }} />The problem</div>
        <h2 className="font-[family-name:var(--font-fraunces)] font-light tracking-[-0.04em] leading-[1.08] mb-5" style={{ fontSize: "clamp(34px, 3.5vw, 50px)", color: "var(--ink)" }}>
        ...
        <div className="rounded-r-[var(--r)] p-5 px-6" style={{ borderLeft: "3px solid var(--green3)", background: "var(--green-bg)" }}>
          <p className="font-[family-name:var(--font-fraunces)] text-[15px] font-light italic leading-[1.6] mb-[10px]" style={{ color: "var(--ink2)" }}>
      ...
      <ScrollReveal>
        <div className="grid grid-cols-2 max-[640px]:grid-cols-1 gap-[2px] overflow-hidden" style={{ border: "1px solid var(--border)", borderRadius: "var(--r-xl)" }}>
          {painCards.map((c) => (
            <div key={c.title} className="p-8 px-7 transition-colors hover:bg-[var(--bg)]" style={{ background: "var(--white)" }}>
              <div className="w-[42px] h-[42px] rounded-[var(--r)] flex items-center justify-center text-[18px] mb-4" style={{ background: "var(--bg2)" }}>{c.icon}</div>
              <h3 className="font-[family-name:var(--font-fraunces)] text-[17px] font-normal tracking-[-0.02em] leading-[1.2] mb-2" style={{ color: "var(--ink)" }}>{c.title}</h3>
...
export function Product() {
  return (
    <section id="product" className="py-[120px] max-[1080px]:py-20 px-[52px] max-[1080px]:px-8 relative overflow-hidden" style={{ background: "var(--ink)" }}>
      <div className="absolute top-[-200px] left-1/2 -translate-x-1/2 w-[900px] h-[600px] pointer-events-none" style={{ background: "radial-gradient(ellipse, rgba(26,148,89,0.1) 0%, transparent 70%)" }} />
      <div className="max-w-[var(--max)] mx-auto relative z-[1]">
        <div className="flex justify-between items-end mb-[72px] max-[640px]:flex-col max-[640px]:gap-4 max-[640px]:items-start">
          <h2 className="font-[family-name:var(--font-fraunces)] font-light tracking-[-0.04em] leading-[1.05] text-white" style={{ fontSize: "clamp(36px, 4vw, 58px)" }}>
            Live in <em className="italic" style={{ color: "var(--green3)" }}>5 days.</em><br />No IT project.
          </h2>
          <p className="max-w-[300px] text-[14px] leading-[1.7] text-right max-[640px]:text-left max-[640px]:max-w-full" style={{ color: "rgba(255,255,255,0.38)" }}>
        ...
        <div className="grid grid-cols-4 max-[1080px]:grid-cols-2 max-[640px]:grid-cols-1 gap-px overflow-hidden" style={{ background: "rgba(255,255,255,0.06)", borderRadius: "var(--r-xl)" }}>
          {steps.map((s, i) => (
            <div key={s.n} className="p-10 px-8 relative transition-colors" style={{ background: "rgba(255,255,255,0.03)" }}>
              <div className="flex items-center justify-between font-[family-name:var(--font-dm-mono)] text-[11px] font-medium tracking-[0.06em] mb-10" style={{ color: "rgba(255,255,255,0.2)" }}>
                {s.n}
              ...
              <h3 className="font-[family-name:var(--font-fraunces)] text-[20px] font-light tracking-[-0.03em] text-white leading-[1.2] mb-[10px]">{s.title}</h3>
...
export function Features() {
  return (
    <section id="features" className="section-padding py-[120px] max-[1080px]:py-20">
      <div className="grid grid-cols-2 max-[1080px]:grid-cols-1 gap-20 max-[1080px]:gap-6 items-end mb-[72px]">
        <div>
          <div className="eyebrow mb-5"><span className="inline-block w-6 h-px" style={{ background: "var(--ink4)" }} />Platform capabilities</div>
          <h2 className="font-[family-name:var(--font-fraunces)] font-light tracking-[-0.04em] leading-[1.06]" style={{ fontSize: "clamp(34px, 3.8vw, 54px)", color: "var(--ink)" }}>
            Built for Ghana&apos;s<br /><em className="italic" style={{ color: "var(--green2)" }}>real</em> workforce
          </h2>
        </div>
        <p className="text-[15px] leading-[1.75] max-w-[420px]" style={{ color: "var(--ink3)" }}>
      ...
      <ScrollReveal>
        <div className="grid grid-cols-2 max-[1080px]:grid-cols-1 gap-16 items-end overflow-hidden p-12 px-12 pb-0 max-[1080px]:p-9 max-[1080px]:pb-0 mb-[2px]" style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: "var(--r-xl) var(--r-xl) 0 0" }}>
          <div>
            <div className="inline-flex items-center gap-[6px] rounded-[6px] px-[10px] py-1 text-[10px] font-semibold tracking-[0.05em] uppercase mb-5" style={{ background: "var(--green-bg)", border: "1px solid rgba(10,92,52,0.15)", color: "var(--green)" }}>✦ Core feature</div>
            <h3 className="font-[family-name:var(--font-fraunces)] text-[30px] font-light tracking-[-0.04em] leading-[1.1] mb-[14px]" style={{ color: "var(--ink)" }}>Real-time wage accrual engine</h3>
            ...
            <div className="flex gap-7 pt-5" style={{ borderTop: "1px solid var(--border)" }}>
              {[{ val: "~90", unit: "s", label: "MoMo disbursement" }, { val: "100", unit: "%", label: "Recovery rate" }, { val: "GHS 3", unit: "", label: "Per withdrawal" }].map((m) => (
                <div key={m.label}>
                  <div className="font-[family-name:var(--font-fraunces)] text-[28px] font-light tracking-[-0.04em] leading-none" style={{ color: "var(--ink)" }}>
          ...
          <div className="flex justify-center max-[1080px]:hidden">
            <div className="w-[220px] rounded-[30px_30px_0_0] p-[10px] pb-0" style={{ background: "var(--ink)", boxShadow: "0 -8px 40px rgba(0,0,0,0.12)" }}>
              <div className="rounded-[22px_22px_0_0] overflow-hidden min-h-[340px]" style={{ background: "var(--bg)" }}>
                <div className="w-16 h-[22px] mx-auto rounded-b-xl" style={{ background: "var(--ink)" }} />
                <div className="p-[14px] pb-0">
                  <div className="text-[9px] font-[family-name:var(--font-dm-mono)] mb-[2px]" style={{ color: "var(--ink4)" }}>THURSDAY · MARCH 27</div>
                  <div className="font-[family-name:var(--font-fraunces)] text-[16px] font-light tracking-[-0.04em] mb-3" style={{ color: "var(--ink)" }}>Hello, Kofi 👋</div>
                  <div className="rounded-xl p-[14px] mb-[10px]" style={{ background: "var(--ink)" }}>
                    <div className="text-[8px] font-medium tracking-[0.05em] uppercase mb-[3px]" style={{ color: "rgba(255,255,255,0.4)" }}>Available to withdraw</div>
                    <div className="font-[family-name:var(--font-fraunces)] text-[26px] font-light tracking-[-0.04em] leading-none text-white mb-2">GHS 1,240</div>
                    <div className="h-[3px] rounded-sm overflow-hidden mb-1" style={{ background: "rgba(255,255,255,0.1)" }}>
                      <div className="w-[62%] h-full" style={{ background: "var(--green3)" }} />
                    </div>
                    <div className="flex justify-between text-[8px] font-[family-name:var(--font-dm-mono)]" style={{ color: "rgba(255,255,255,0.25)" }}>
                      <span>Day 19 of 31</span><span>62% accrued</span>
                    </div>
                  </div>
                  <button className="w-full rounded-lg py-[9px] text-[11px] font-semibold text-white mb-[10px] font-[family-name:var(--font-dm-sans)]" style={{ background: "var(--green3)" }}>
                    Withdraw to MoMo →
                  </button>
                </div>
              </div>
      ...
      {/* Feature grid */}
      <div className="grid grid-cols-3 max-[1080px]:grid-cols-2 max-[640px]:grid-cols-1 gap-[2px]">
        {featureCards.map((f, i) => (
          <ScrollReveal key={f.title}>
            <div className="p-8 px-7 transition-colors hover:bg-[var(--bg)]" style={{ background: "var(--white)", border: "1px solid var(--border)", borderRadius: i === 0 ? "0 0 0 var(--r-xl)" : i === featureCards.length - 1 ? "0 0 var(--r-xl) 0" : undefined }}>
              <div className="w-10 h-10 rounded-[9px] flex items-center justify-center text-[17px] mb-4" style={{ background: "var(--bg2)" }}>{f.icon}</div>
              <h3 className="font-[family-name:var(--font-fraunces)] text-[17px] font-normal tracking-[-0.02em] leading-[1.2] mb-2" style={{ color: "var(--ink)" }}>{f.title}</h3>
        ...
        <div className="grid grid-cols-3 max-[1080px]:grid-cols-1 gap-12 p-14 px-16 max-[1080px]:p-10" style={{ background: "var(--bg2)", border: "1px solid var(--border)", borderRadius: "var(--r-2xl)" }}>
          {trustItems.map((t) => (
            <div key={t.title}>
              ...
              <h3 className="font-[family-name:var(--font-fraunces)] text-[18px] font-normal tracking-[-0.02em] mb-2" style={{ color: "var(--ink)" }}>{t.title}</h3>
...
export function Numbers() {
  return (
    <section className="py-24 max-[1080px]:py-20 px-[52px] max-[1080px]:px-8 relative overflow-hidden" style={{ background: "var(--ink)" }}>
      <div className="max-w-[var(--max)] mx-auto relative z-[1]">
        <div className="flex justify-between items-end mb-16 max-[640px]:flex-col max-[640px]:gap-4 max-[640px]:items-start">
          <h2 className="font-[family-name:var(--font-fraunces)] font-light tracking-[-0.04em] leading-[1.08] text-white" style={{ fontSize: "clamp(32px, 3.5vw, 48px)" }}>
            The numbers<br /><em className="italic" style={{ color: "var(--green3)" }}>speak plainly.</em>
          </h2>
          <p className="max-w-[260px] text-[13px] text-right max-[640px]:text-left leading-[1.6]" style={{ color: "rgba(255,255,255,0.3)" }}>
        ...
        <div className="grid grid-cols-4 max-[1080px]:grid-cols-2 overflow-hidden" style={{ border: "1px solid rgba(255,255,255,0.06)", borderRadius: "var(--r-xl)" }}>
          {stats.map((s, i) => (
            <div key={s.label} className="p-10 px-9 transition-colors hover:bg-[rgba(255,255,255,0.03)]" style={{ borderRight: i < 3 ? "1px solid rgba(255,255,255,0.06)" : "none" }}>
              <div className="font-[family-name:var(--font-fraunces)] font-extralight tracking-[-0.05em] leading-none text-white mb-3" style={{ fontSize: "clamp(42px, 4.5vw, 64px)" }}>
                <em style={{ color: "var(--green3)", fontStyle: "normal" }}>{s.num}</em>{s.suffix}
              </div>
              <div className="text-[14px] font-medium mb-[6px]" style={{ color: "rgba(255,255,255,0.5)" }}>{s.label}</div>
              <div className="text-[11px] leading-[1.5] font-[family-name:var(--font-dm-mono)]" style={{ color: "rgba(255,255,255,0.22)" }}>{s.note}</div>
            </div>
          ))}
        </div>
      </div>
...
export function Compare() {
  return (
    <section className="section-padding py-[120px] max-[1080px]:py-20">
      <div className="grid gap-20 max-[1080px]:grid-cols-1 max-[1080px]:gap-4 items-end mb-14" style={{ gridTemplateColumns: "1fr 360px" }}>
        <div>
          ...
          <h2 className="font-[family-name:var(--font-fraunces)] font-light tracking-[-0.04em] leading-[1.06]" style={{ fontSize: "clamp(34px, 3.8vw, 52px)", color: "var(--ink)" }}>
      ...
      <ScrollReveal>
        <div className="overflow-x-auto" style={{ border: "1px solid var(--border)", borderRadius: "var(--r-xl)" }}>
          <div className="grid min-w-[700px]" style={{ gridTemplateColumns: "2fr 1.4fr 1fr 1fr 1fr", background: "var(--bg2)", borderBottom: "1px solid var(--border)" }}>
            {["Criteria", "WageNow (EWA)", "Loan Apps", "Manual Advance", "Credit Card"].map((h, i) => (
              <div key={h} className="p-[14px] px-5 text-[11px] font-bold tracking-[0.05em] uppercase" style={{ color: i === 1 ? "rgba(255,255,255,0.6)" : "var(--ink4)", background: i === 1 ? "var(--ink)" : undefined }}>{h}</div>
            ))}
          </div>
          {compareRows.map((r) => (
            <div key={r.label} className="grid min-w-[700px] hover:bg-[var(--bg)]" style={{ gridTemplateColumns: "2fr 1.4fr 1fr 1fr 1fr", borderBottom: "1px solid var(--border)" }}>
              <div className="p-[14px] px-5 text-[13px] font-medium flex items-center" style={{ color: "var(--ink)" }}>{r.label}</div>
              <div className="p-[14px] px-5 text-[12px] font-semibold font-[family-name:var(--font-dm-mono)] flex items-center" style={{ color: "var(--green)", background: "rgba(26,148,89,0.04)" }}>{r.wn}</div>
              <div className={`p-[14px] px-5 text-[12px] font-[family-name:var(--font-dm-mono)] flex items-center ${clsMap[r.loan.cls]}`}>{r.loan.text}</div>
              <div className={`p-[14px] px-5 text-[12px] font-[family-name:var(--font-dm-mono)] flex items-center ${clsMap[r.manual.cls]}`}>{r.manual.text}</div>
              <div className={`p-[14px] px-5 text-[12px] font-[family-name:var(--font-dm-mono)] flex items-center ${clsMap[r.cc.cls]}`}>{r.cc.text}</div>
            </div>
          ))}
        </div>
      </ScrollReveal>
...
export function Testimonials() {
  return (
    <section id="testi" className="pb-[120px] max-[1080px]:pb-20 px-[52px] max-[1080px]:px-8" style={{ background: "var(--bg2)", borderTop: "1px solid var(--border)", borderBottom: "1px solid var(--border)" }}>
      <div className="max-w-[var(--max)] mx-auto pt-[120px] max-[1080px]:pt-20">
        ...
        <div className="grid grid-cols-3 max-[1080px]:grid-cols-1 gap-5">
          {testimonials.map((t) => (
            <ScrollReveal key={t.name}>
              <div className="flex flex-col p-9 rounded-[var(--r-xl)] transition-all hover:shadow-lg hover:-translate-y-[2px]" style={{ background: "var(--white)", border: "1px solid var(--border)" }}>
                <div className="flex gap-[3px] mb-5">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="w-[14px] h-[14px]" style={{ background: "var(--gold)", clipPath: "polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)" }} />
                  ))}
                </div>
                <p className="font-[family-name:var(--font-fraunces)] text-[15px] font-light italic leading-[1.7] flex-1 mb-6" style={{ color: "var(--ink2)" }}>&ldquo;{t.quote}&rdquo;</p>
                <div className="flex items-center gap-3 pt-5" style={{ borderTop: "1px solid var(--border)" }}>
                  ...
                  <div>
                    ...
                    <div className="text-[11px] mt-[1px]" style={{ color: "var(--ink4)" }}>{t.role}</div>
                  </div>
                </div>
              </div>
            </ScrollReveal>
...
export function Pricing() {
  return (
    <section id="pricing" className="section-padding py-[120px] max-[1080px]:py-20">
      <div className="text-center mb-16">
        ...
        <h2 className="font-[family-name:var(--font-fraunces)] font-light tracking-[-0.04em] leading-[1.05] mb-[14px]" style={{ fontSize: "clamp(36px, 4vw, 56px)", color: "var(--ink)" }}>
          Simple, <em className="italic" style={{ color: "var(--green2)" }}>honest</em> pricing
        </h2>
        <p className="text-[16px] leading-[1.7] max-w-[520px] mx-auto" style={{ color: "var(--ink3)" }}>
      ...
      <div className="grid grid-cols-3 max-[1080px]:grid-cols-1 gap-5">
        {plans.map((p) => (
          <ScrollReveal key={p.name}>
            <div className="flex flex-col rounded-[var(--r-xl)] p-9 relative transition-shadow hover:shadow-lg" style={{ background: p.featured ? "var(--ink)" : "var(--white)", border: p.featured ? "1.5px solid var(--ink)" : "1.5px solid var(--border)", boxShadow: p.featured ? "0 20px 64px rgba(24,22,15,0.18)" : undefined }}>
              <div className="text-[10px] font-bold tracking-[0.1em] uppercase px-[10px] py-[3px] rounded-full w-fit mb-6" style={{
              ...
              <div className="font-[family-name:var(--font-fraunces)] text-[24px] font-light tracking-[-0.04em] mb-[6px]" style={{ color: p.featured ? "#fff" : "var(--ink)" }}>{p.name}</div>
              <div className="font-[family-name:var(--font-fraunces)] font-extralight tracking-[-0.05em] leading-none mb-1" style={{ fontSize: p.price === "Custom" ? 38 : 52, color: p.featured ? "#fff" : "var(--ink)" }}>
                {p.price !== "Custom" && <sup className="text-[22px] align-super tracking-normal">GHS</sup>}{p.price}
              </div>
              <div className="text-[12px] font-[family-name:var(--font-dm-mono)] mb-7" style={{ color: p.featured ? "rgba(255,255,255,0.35)" : "var(--ink4)" }}>{p.cadence}</div>
              ...
              <div className="flex-1 flex flex-col gap-[11px] mb-8">
                {p.features.map((f) => (
                  <div key={f} className="flex items-start gap-[10px] text-[13px] leading-[1.4]" style={{ color: p.featured ? "rgba(255,255,255,0.65)" : "var(--ink2)" }}>
                    <div className="w-4 h-4 rounded flex items-center justify-center text-[9px] shrink-0 mt-[1px]" style={{ background: p.featured ? "rgba(255,255,255,0.1)" : "var(--green-bg)", color: p.featured ? "rgba(255,255,255,0.6)" : "var(--green)" }}>✓</div>
                    {f}
                  </div>
                ))}
              </div>
              <button className="w-full py-3 rounded-[9px] text-[14px] font-medium cursor-pointer font-[family-name:var(--font-dm-sans)] transition-all" style={{
...
export function CTA() {
  return (
    <section id="contact" className="px-[52px] max-[1080px]:px-8 pb-[120px] max-[1080px]:pb-20">
      <div className="max-w-[var(--max)] mx-auto">
        <div className="grid grid-cols-[1fr_340px] max-[1080px]:grid-cols-1 gap-20 max-[1080px]:gap-10 items-center p-24 px-20 max-[1080px]:p-14 max-[1080px]:px-10 relative overflow-hidden" style={{ background: "var(--ink)", borderRadius: "var(--r-2xl)" }}>
          <div className="absolute top-[-150px] left-[-100px] w-[700px] h-[600px] pointer-events-none" style={{ background: "radial-gradient(ellipse, rgba(26,148,89,0.12) 0%, transparent 65%)" }} />
          ...
          <div className="relative z-[1]">
            <div className="flex items-center gap-[10px] text-[11px] font-semibold tracking-[0.1em] uppercase mb-5" style={{ color: "rgba(255,255,255,0.3)" }}>
              <span className="inline-block w-5 h-px" style={{ background: "rgba(255,255,255,0.2)" }} />Get started today
            </div>
            <h2 className="font-[family-name:var(--font-fraunces)] font-light tracking-[-0.04em] leading-[1.03] text-white mb-[18px]" style={{ fontSize: "clamp(36px, 4.2vw, 60px)" }}>
              Your employees have<br /><em className="italic" style={{ color: "var(--green3)" }}>already earned</em><br />this money.
            </h2>
            <p className="text-[15px] leading-[1.7] max-w-[480px]" style={{ color: "rgba(255,255,255,0.4)" }}>
          ...
          <div className="relative z-[1] rounded-[var(--r-xl)] p-9" style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)" }}>
            ...
            <div className="flex flex-col gap-3">
              {["Your name", "Company name", "Work email", "Number of employees"].map((ph) => (
                <input
                  ...
                  placeholder={ph}
                  className="w-full px-4 py-[11px] rounded-lg text-[14px] text-white outline-none transition-all focus:border-[rgba(26,148,89,0.5)] focus:bg-[rgba(255,255,255,0.09)] font-[family-name:var(--font-dm-sans)]"
                  style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.1)" }}
                />
              ))}
              <button className="w-full py-[13px] rounded-lg text-[14px] font-semibold cursor-pointer transition-opacity hover:opacity-90 font-[family-name:var(--font-dm-sans)]" style={{ background: "#fff", color: "var(--ink)", border: "none", letterSpacing: "-0.01em" }}>
                Request access →
              </button>
              <p className="text-[11px] text-center leading-[1.5]" style={{ color: "rgba(255,255,255,0.22)" }}>
