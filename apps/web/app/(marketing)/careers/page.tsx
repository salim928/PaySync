...
export const metadata: Metadata = {
  title: "Careers",
  description: "Join WageNow — we're building financial infrastructure that gives Ghana's workforce real-time access to earned wages.",
};
...
const openings = [
  {
    ...
    type: "Full-time",
    description: "Build and scale the FastAPI backend powering EWA transactions, payroll integrations, and MoMo disbursements. Python, PostgreSQL, async architecture.",
  },
  {
  ...
  {
    title: "Business Development Lead — Ghana",
    department: "Commercial",
    location: "Accra",
    type: "Full-time",
    description: "Own employer acquisition in Greater Accra. Build relationships with HR leaders, run demos, and close deals. Background in B2B SaaS or fintech preferred.",
  },
  {
...
const perks = [
  { title: "Competitive salary", body: "Market-rate compensation in GHS or USD, depending on your preference." },
  { title: "Remote-friendly", body: "Work from Accra, anywhere in Ghana, or fully remote. We care about output, not office hours." },
  ...
  return (
    <>
      <PageHeader
        ...
        subtitle="WageNow is eliminating the gap between earning and accessing wages for Ghana's workforce. We're a small, fast team — every person here has outsized impact."
      />
